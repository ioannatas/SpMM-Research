#ifndef SDDMM_KERNELS_H
#define SDDMM_KERNELS_H
...
struct Matrix_Format * csr_to_format(INT_T * row_ptr, INT_T * col_ind, ValueType * values, long m, long nnz , long n, ValueType *x, ValueType *z);
int statistics_print_labels(char * buf, long buf_n);


#endif /* SDDMM_KERNELS_H */
