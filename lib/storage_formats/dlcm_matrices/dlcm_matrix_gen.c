...
#ifndef DLCM_MATRIX_GEN_C
#define DLCM_MATRIX_GEN_C
...
static
void
smtx_parse_array_format(char ** lines, long * lengths, struct DLCM_Matrix * MTX)
{
...
// static
// void
// smtx_parse_coordinate_format(char ** lines, long * lengths, struct DLCM_Matrix * MTX, long expand_symmetry)
// {
...
static
void
smtx_parse_data(char ** lines, long * lengths, struct DLCM_Matrix * MTX, long expand_symmetry)
{
...
static
struct Vector *
smtx_to_string(struct DLCM_Matrix * MTX)
{
	int * R = MTX->R;
	int * C = MTX->C;
	TYPE * V = MTX->V;
...
// static
// long
// smtx_to_string_par(struct DLCM_Matrix * MTX, char ** str_ptr)
// {
// 	int num_threads = safe_omp_get_num_threads_external();
// 	int * R = MTX->R;
// 	int * C = MTX->C;
